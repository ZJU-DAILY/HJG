...
class IndexGraph : public Index {
 public:
  ...
  virtual void Build(size_t n, const vector<string> data, const Parameters &parameters) override;
  ...
  void setPivot(unsigned p);
  void SaveGraph(const char *filename, vector<unsigned> mapToId);
 ...
 private:
  ...
  void generate_control_set(std::vector<unsigned> &c,
                                      ...
                                      unsigned N);
  void generate_control_setS(std::vector<unsigned> &c,
                                      std::vector<std::vector<unsigned> > &v,
                                      unsigned N);
